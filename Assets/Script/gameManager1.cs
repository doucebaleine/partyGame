...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        finJeu = false;
        vitesseAlien = 0.005f;
        // On appelle la coroutine qui permet de faire appara�tre des aliens
    ...
    IEnumerator SpawnAlien()
    {
        ...
        while (true)
        {
            ...
            // On instanciate un alien � cette position
    ...
    IEnumerator FinTuto()
    {
        // On attend 10 secondes avant de faire dispara�tre le tuto
        yield return new WaitForSeconds(5f);
